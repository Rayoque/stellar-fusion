  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-[#0f0f15]/95 border border-white/10 p-6 sm:p-8 rounded-[32px] max-w-2xl w-full h-[550px] md:h-[440px] max-h-[90vh] md:max-h-[85vh] overflow-hidden flex flex-col gap-6 text-white shadow-[0_16px_48px_rgba(0,0,0,0.7)] relative isolate"
      >
        {/* Close Button */}
        <button 
          onClick={onClose}
